...
function generateit(){
     return "<label for='her'>Enter the grade points</label><input type='text' class='txt'><label for='her'>Enter the credit points</label><input type='text' class='jxt'><br><br>";
  }
